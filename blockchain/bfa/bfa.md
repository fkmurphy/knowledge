...
- El canal técnico en Telegram está abierto al público y esto hace un poco más alcanzable para consultas. Sin embargo, creo que es necesario que haya mejor recepción en cuanto a las personas que llegan o que intentar brindar una crítica constructiva. Creo que tener otro enfoque más comunitario y abierto a diferentes opiniones va a hacer crecer el ecosistema. Actualmente encuentro que las personas que ingresan al grupo llegan con el fin de hacer un relevamiento para una investigación o tesis. De las personas que llegan para desarrollo, suelen conseguir una gran advertencia sobre el exceso de uso de gas, sobre googlear y leer código o sobre las bases del software libre y la comunidad. Creo que esto último en particular no fortalece a la comunidad y hace que se cierren oportunidades de personas que son potenciales colaboradores que quizá hoy no escribieron ni una sola letra, pero en un futuro sean parte de grandes desarrollos.
